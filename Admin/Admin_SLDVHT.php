	...
	<script>
          ...
          let massPopChart = new Chart(myChart, {
                  ...
                  <?php
                    ...
                    while($tv_2=mysqli_fetch_array($tv_1))
                    {
                      if($tv_2!=false)
                      {
                        echo "'".$tv_2['TenKVTV']."',";
                        //lấy data
                        $tvc="Select COUNT(IDKhachSan) as sl from Phong where IDKhuVuc = '". $tv_2['IDKhuVuc'] ."'";
            ...
            options:{
              title:{
                display:true,
                text:'Biểu đồ số lượng đơn vị cho thuê phòng tại các tỉnh',
                fontSize:25
              },
              legend:{
                display:false,
